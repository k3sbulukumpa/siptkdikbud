      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-zinc-900 px-5 py-3.5 text-white font-bold flex justify-between items-center text-xs uppercase tracking-widest border-b border-zinc-800">
          <span className="flex items-center gap-1.5">
            ...
            <span>Pengaturan Unduh Excel DUK</span>
          </span>
          <button onClick={onClose} className="text-zinc-400 hover:text-white transition cursor-pointer" type="button">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleCetakSubmit} className="p-5 space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-3 border-t border-zinc-805">
            ...
            <button
              type="submit"
              className="bg-amber-600 hover:bg-amber-555 text-white px-5 py-2 rounded-lg text-xs font-extrabold uppercase tracking-widest transition flex items-center justify-center gap-1.5 cursor-pointer"
            >
